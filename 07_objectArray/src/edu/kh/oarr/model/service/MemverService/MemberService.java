//package edu.kh.oarr.model.service.MemverService;
//
...
//	 
//	 //memberArr 배열을 0 인덱스 부터 끝까지 접근해서
//	 //참조하는 값이 null인 경우의 인덱스를 반환
//	 for(int i=0; i < memberArr.length; i++) {
//		 if(memberArr[i] == null) {
//			 return i; // 현재 메서드를 종료하고 호출한곳으로 i값 가지고 돌아감
//		 }
//	 }
...
//	 System.out.println("\n=========회원가입 =-======");
//	 
//	 //객체배열 memberArr 에 가입한 회원 정보를 저장할 에정
//	 //-> 새로운 회원정보를 저장할 공간이 있는지 ㅎ솩인하고
//	 // 빈 공간의 인덱스 번호를 얻어오기
...
//			
//			//2) 회원 정보(memberArr[i]의 아이디, 비밀번호화
...
//				// 현재 접근중인 memberArr[i] 요소에 저장된 주소를 알아 본다
...
//		// 입력받은 지역(inputRegion)과 같은경우 회원의 아이디, 이름을 출력
