package edu.kh.excepion.model.service;
...
public class ExceptionService {
	...
	public void ex1() {
		...
		try {
			...
			// java.lang.ArithmeticException : 산술적예외 0으로 나눌수 없다.
			
		} catch( java.lang.ArithmeticException e) {
			// try 에서 던져진 예외를 catch문 매개변수 e로 잡음.
			
			
		 System.out.println("inpinity"); // 처리 코드 
		}
	...
	public void ex2() {
		//여러가지 예외에 대한 처리 방법
			...
			int num1 = sc.nextInt(); //java.lang.NullPointerException
			
			System.out.println("입력2 : ");
			int num2 = sc.nextInt(); //java.lang.NullPointerException
			
			
			System.out.println("결과 : " + num1 / num2); // ArithmeticExeption
			
			
			String str = null;
			
			System.out.println(str.charAt(0));
			//java.lang.NullPointerException : 참조하지 않은 참조변수를 이용해서 코드 수행 시 발생
			
				
			
		} catch(Exception e) {
			System.out.println("무너지 모르겠으나 예외가 발생해서 처리함.");
			
			// 예외처리 +다형성 
			// Exception 클래스 : 모든 예외ㅡ이 최상위 부모
